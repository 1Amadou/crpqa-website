...
@section('title', __('Créer une Catégorie d\'Actualité'))

@section('header')
    <div class="flex flex-wrap justify-between items-center gap-4">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-white leading-tight">
            {{ __('Créer une Nouvelle Catégorie d\'Actualité') }}
        </h1>
    ...
    <div class="px-4 py-5 sm:p-6 md:p-8">
        ...
        <form action="{{ route('admin.news-categories.store') }}" method="POST">
            @include('admin.news_categories._form', [
                'category' => $category // $category est une nouvelle instance passée par le contrôleur
            ])
